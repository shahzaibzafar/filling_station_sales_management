...
$(document).ready(function(){
    ...
    var fieldHTML = '<div class="col-12" style="clear: both;"><div class="form-row"><div class="form-group col-md-5"><input type="text" class="form-control" id="inputEmail4" placeholder="expense" name="expense[]"></div><div class="form-group col-md-5"><input type="number" class="form-control" id="inputPassword4" placeholder="0.00" name="cost[]" style="text-align:right"></div><a href="#" class="col-md-2 remove_button"><p class="btn btn-dark ">remove</p></a></div></div>';
